...
// ==========================================
const gamesList = [
    { id: 1, title: "The Last of Us", price: "₹199", img: "images/gameimg/g4.jpeg", category: "Adventure",
    ...
    { id: 2, title: "Red Dead Redemption II", price: "₹210", img: "images/gameimg/g5.jpeg", category: "Adventure",
    ...
    { id: 3, title: "Silent Hill", price: "₹150", img: "images/gameimg/g6.jpeg", category: "Simulation",
    ...
    { id: 4, title: "Lords of The Fallen", price: "₹150", img: "images/gameimg/g7.jpeg", category: "Action",
    ...
    { id: 5, title: "Roblox", price: "₹180", img: "images/gameimg/g8.jpeg", category: "Simulation",
    ...
    { id: 6, title: "Sinking City", price: "₹280", img: "images/gameimg/g9.jpeg", category: "Action",   
    ...
    { id: 7, title: "Minecraft", price: "₹200", img: "images/gameimg/g10.jpeg", category: "Simulation", 
        description: "A sandbox game where players can build and explore block-based worlds." },

    { id: 8, title: "Amnesia", price: "₹150", img: "images/gameimg/g11.jpeg", category: "Simulation", 
        description: "A psychological horror game where players experience memory loss and confusion." },

    { id: 9, title: "Grand Theft Auto V", price: "₹210", img: "images/gameimg/g12.jpeg", category: "Action", 
        description: "An open-world action-adventure game set in the fictional city of Los Santos." },

    { id: 10, title: "Need for Speed", price: "₹180", img: "images/gameimg/g13.jpeg", category: "Action", 
        description: "A racing game focused on street racing and car customization." },

    { id: 11, title: "Zelda", price: "₹150", img: "images/gameimg/g14.jpeg", category: "Adventure", 
        description: "An action-adventure game featuring Link as he rescues Princess Zelda from the evil Ganon." },

    { id: 12, title: "Uncharted 4", price: "₹190", img: "images/gameimg/g15.jpeg", category: "Adventure", 
        description: "An action-adventure game following the adventures of treasure hunter Nathan Drake." }
];

const booksList = [
    { id: 101, title: "Wuthering Heights", author: "Emily Brontë", genre: "Classics", price: "₹200", img: "images/bookimg/1.jpg",
      description: "A tragic love story between Catherine and Heathcliff set on the Yorkshire moors." }, 

    { id: 102, title: "Sherlock Holmes", author: "Arthur Conan Doyle", genre: "Mystery", price: "₹200", img: "images/bookimg/2.jpg",
      description: "Follow the legendary detective Sherlock Holmes solving mysterious crimes." },

    { id: 103, title: "Anna Karenina", author: "Leo Tolstoy", genre: "Classics", price: "₹159", img: "images/bookimg/3.jpg",
      description: "A deep novel exploring love, betrayal, and Russian society." },

    { id: 104, title: "House of Sky and Breath", author: "Sarah J. Maas", genre: "Fiction", price: "₹180", img: "images/bookimg/4.jpg",
      description: `Fantasy novel full of magic, danger, and romance.<br>
      <b>Author:</b> Sarah J. Maas` },

    { id: 105, title: "The Secret History", author: "Donna Tartt", genre: "Fiction", price: "₹159", img: "images/bookimg/5.jpg",
      description: "A dark academia novel about obsession and murder." },

    { id: 106, title: "1984", author: "George Orwell", genre: "Classics", price: "₹160", img: "images/bookimg/6.jpg",
      description: "A dystopian novel about surveillance and totalitarian control." },

    { id: 107, title: "Caraval", author: "Stephanie Garber", genre: "Fiction", price: "₹180", img: "images/bookimg/7.jpg",
      description: "A magical competition where nothing is what it seems." },

    { id: 108, title: "Two Twisted Crowns", author: "Rachel Gillig", genre: "Fiction", price: "₹159", img: "images/bookimg/8.jpg",
      description: "A dark fantasy filled with cursed magic and secrets." },

    { id: 109, title: "Pride and Prejudice", author: "Jane Austen", genre: "Classics", price: "₹200", img: "images/bookimg/9.jpg",
      description: "A romantic novel of manners set in Georgian England." },

    { id: 110, title: "Murder on the Orient Express", author: "Agatha Christie", genre: "Mystery", price: "₹200", img: "images/bookimg/10.jpg",
      description: "A classic whodunit mystery featuring Hercule Poirot." },

    { id: 111, title: "The Girl with the Dragon Tattoo", author: "Stieg Larsson", genre: "Mystery", price: "₹159", img: "images/bookimg/11.jpg",
      description: "A journalist and hacker investigate a disappearance in this thriller." },

    { id: 112, title: "Gone Girl", author: "Gillian Flynn", genre: "Mystery", price: "₹159", img: "images/bookimg/12.jpg",
      description: "A psychological thriller about a missing wife and marital secrets." }
];

const moviesList = [
    { id: 1001, title: "Fight Club", price: "₹150", img: "images/movieimg/m1.jpeg", videoFile: "https://www.youtube.com/embed/O1nDozs-LxI?si=ojWB1rHSbPJnADMc",
    ...
    { id: 1002, title: "Interstellar", price: "₹200", img: "images/movieimg/m2.jpeg", videoFile: "https://www.youtube.com/embed/zSWdZVtXT7E?si=BCo_A12lhh0Y42Gc", 
    ...
    { id: 1003, title: "Jumanji Next Level", price: "₹179", img: "images/movieimg/m3.jpeg", videoFile: "https://www.youtube.com/embed/rBxcF-r9Ibs?si=17pA_7CKk8YAXusa",
    ...
    { id: 1004, title: "Spiderman", price: "₹200", img: "images/movieimg/m4.jpeg", videoFile: "https://www.youtube.com/embed/DiTECkLZ8HM?si=2n3nvHppGBq3WMd5",
    ...
    { id: 1005, title: "IT", price: "₹160", img: "images/movieimg/m5.jpeg", videoFile: "https://www.youtube.com/embed/FnCdOQsX5kc?si=KldZGKn_phYhPxs1",
    ...
    { id: 1006, title: "The Batman", price: "₹190", img: "images/movieimg/m6.jpeg", videoFile: "https://www.youtube.com/embed/mqqft2x_Aa4?si=DEArUp5j7L2c_Rz3",
    ...
    { id: 1007, title: "Pirates of the Caribbean", price: "₹159", img: "images/movieimg/m7.jpeg", videoFile: "https://www.youtube.com/embed/KpFMVcZ4o7U?si=Rawe_h_GgV4BNYRP",
    ...
    { id: 1008, title: "The Truman Show", price: "₹150", img: "images/movieimg/m8.jpeg", videoFile: "https://www.youtube.com/embed/dlnmQbPGuls?si=C31bM-96i5su1T9S",
    ...
    { id: 1009, title: "Midsommar", price: "₹170", img: "images/movieimg/m9.jpeg", videoFile: "https://www.youtube.com/embed/1Vnghdsjmd0?si=V5nxGnX4wXVguEuK",
    ...
    { id: 1010, title: "Dune", price: "₹160", img: "images/movieimg/m10.jpeg", videoFile: "https://www.youtube.com/embed/n9xhJrPXop4?si=OHWGAaDyBBlMoa4v",
    ...
    { id: 1011, title: "Black Phone 2", price: "₹200", img: "images/movieimg/m11.jpeg", videoFile: "https://www.youtube.com/embed/v0kqkRZHqk4?si=awwxN0mWUf9Qf9uO",
    ...
    { id: 1012, title: "The Conjuring", price: "₹190", img: "images/movieimg/m12.jpeg", videoFile: "https://www.youtube.com/embed/ejMMn0t58Lc?si=G5qFcJ0k_Ly93ubP",
...
function processOrder() {
    if (myLibrary.length === 0) {
        alert("Your library is empty! Add some items first.");
        return;
    }

    // Save current cart details to pending order and continue to checkout page
    const total = myLibrary.reduce((sum, item) => sum + item.total, 0);
    const pendingOrder = {
        items: myLibrary,
        total: total
    };
...
// (Optional) Ensure library overlay is hidden after place order through processOrder path
